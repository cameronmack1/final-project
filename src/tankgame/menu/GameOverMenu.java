...
public class GameOverMenu extends JPanel {
    ...
    public GameOverMenu(GameFrame gf, String winnerName) {
        ...
        try {
            bg = ImageIO.read(ClassLoader.getSystemResource("images/tankGameVictory.jpg")).getScaledInstance(w, h, Image.SCALE_DEFAULT);
            tank = ImageIO.read(ClassLoader.getSystemResource("images/tank.png")).getScaledInstance(w / 7, 2*h / 5, Image.SCALE_DEFAULT);
            selftank = ImageIO.read(ClassLoader.getSystemResource("images/selftank.png")).getScaledInstance(w / 7, 2*h / 5, Image.SCALE_DEFAULT);
        } catch (IOException e) {
